...
public class DAGTests {
  ...
  @Test(timeout=1000) public void dag_empty1(){
    DAG dag = new DAG();
    String expect =
      "Upstream Links:\n"+
      "Downstream Links:\n"+
  ...
  @Test(timeout=1000) public void dag_empty2(){
    DAG dag = new DAG();
                              ...
                              String [] expectDownstream)
  {
    ...
    for(int i=0; i<expectUpstream.length; i+=2){
      ...
      String expect = expectUpstream[i+1];
      String actual = (dag.getUpstreamLinks(id)==null) ? null : dag.getUpstreamLinks(id).toString();
      msg =
    ...
    for(int i=0; i<expectDownstream.length; i+=2){
      ...
      String expect = expectDownstream[i+1];
      String actual = (dag.getDownstreamLinks(id)==null) ? null : dag.getDownstreamLinks(id).toString();
      msg =
  ...
  @Test(timeout=1000) public void dag_basic_add1(){
  ...
  @Test(timeout=1000) public void dag_basic_add2(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
  ...
  @Test(timeout=1000) public void dag_basic_add4(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1","C1","D1"));
    dag.add("B1",toSet("C1","D1"));
  ...
  @Test(timeout=1000) public void dag_basic_add5(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
  ...
  @Test(timeout=1000) public void dag_add_empty_no_change1(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet());
    dag.add("B1",toSet());
  ...
  @Test(timeout=1000) public void dag_add_empty_no_change2(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
  ...
  @Test(timeout=1000) public void dag_add_replace1(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    expectS =
  ...
  @Test(timeout=1000) public void dag_add_replace2(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    dag.add("B1",toSet("C1"));
  ...
  @Test(timeout=1000) public void dag_add_replace3(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1","C1","D1"));
    dag.add("B1",toSet("C1","D1"));
  ...
  @Test(timeout=1000) public void dag_add_replace4(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1","C1","D1"));
    dag.add("B1",toSet("C1","D1"));
  ...
  @Test(timeout=1000) public void dag_add_remove_nonexistent1(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    dag.add("B1",toSet("C1"));
  ...
  @Test(timeout=1000) public void dag_add_remove1(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    dag.remove("A1");
  ...
  @Test(timeout=1000) public void dag_add_remove2(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    dag.remove("B1");
  ...
  @Test(timeout=1000) public void dag_add_remove3(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    dag.add("B1",toSet("C1","D1"));
  ...
  @Test(timeout=1000) public void dag_add_remove4(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1"));
    dag.add("B1",toSet("C1","D1"));
  ...
  @Test(timeout=1000) public void dag_add_remove5(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1","C1","D1"));
  ...
  @Test(timeout=1000) public void dag_add_remove6(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1","C1","D1"));
    dag.add("B1",toSet("E1","C1","D1","F1"));
  ...
  @Test(timeout=1000) public void dag_add_remove7(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag = new DAG();
    dag.add("A1",toSet("B1","C1","D1"));
    dag.add("B1",toSet("E1","C1","D1","F1"));
  ...
  @Test(timeout=1000) public void dag_multiple_add_remove1(){
    String expectS, expectUpstream[], expectDownstream[];
    DAG dag1 = new DAG();
    DAG dag2 = new DAG();
    // Adjust dag1
  ...
  @Test(timeout=1000) public void dag_multiple_add_remove2(){
    String expectS, expectUpstream[], expectDownstream[];
  ...
  @Test(timeout=1000) public void checkForCycles_cycle1(){
  ...
  @Test(timeout=1000) public void checkForCycles_cycle2(){
  ...
  @Test(timeout=1000) public void checkForCycles_cycle3(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_cycle4(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_cycle5(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_cycle6(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_cycle7(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_cycle8(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 C1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_cycle9(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 C1 D1",
      "B1","D1 E1 F1 G1",
  ...
  @Test(timeout=1000) public void checkForCycles_nocycle1(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_nocycle2(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1 D1 E1 F1",
  ...
  @Test(timeout=1000) public void checkForCycles_nocycle3(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_nocycle4(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void checkForCycles_nocycle5(){
    String start; Set<String> expectCycles; boolean expectHasCycle;
    String [] links = {
      "A1","B1 D1",
      "B1","C1",
  ...
  @Test(timeout=1000) public void dag_cycle_exception1(){
  ...
  @Test(timeout=1000) public void dag_cycle_exception2(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1"),
      "B1",toSet("A1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception3(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1"),
      "B1",toSet("C1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception4(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1","X1","Y1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception5(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1","D1","E1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception6(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1"),
      "A1",toSet("A1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception7(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1"),
      "B1",toSet("C1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception8(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1","C1"),
      "B1",toSet("C1"),
  ...
  @Test(timeout=1000) public void dag_cycle_exception10(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1","C1"),
      "B1",toSet("C1"),
  ...
  @Test(timeout=1000) public void dag_nocycle_exception1(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1"),
      "B1",toSet("C1"),
  ...
  @Test(timeout=1000) public void dag_nocycle_exception2(){
    String expectS; Set<String> expectCycles; boolean expectHasCycle;
    Object [] additions = {
      "A1",toSet("B1","D1","E1"),
      "B1",toSet("D1","F1","G1","C1"),
