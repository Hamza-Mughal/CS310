// HW 3 Milestone Tests: Concerns primarily Cell class
import org.junit.*;
import static org.junit.Assert.*;
import java.util.*;

public class HW3MilestoneTests {
  /*Main method runs tests in this file*/ 
  public static void main(String args[])
  {
    org.junit.runner.JUnitCore.main("HW3MilestoneTests");
  } 
  ...
  @Test(timeout=1000) public void cell_string1(){
  ...
  @Test(timeout=1000) public void cell_string2(){
  ...
  @Test(timeout=1000) public void cell_string3(){
  ...
  @Test(timeout=1000) public void cell_string_trim1(){
    Cell cell = Cell.make(" Hello"); 
    assertEquals("string",cell.kind());
    assertEquals("Hello", cell.displayString());
    assertEquals("Hello", cell.contents());
  ...
  @Test(timeout=1000) public void cell_string_trim2(){
  ...
  @Test(timeout=1000) public void cell_number1(){
  ...
  @Test(timeout=1000) public void cell_number2(){
  ...
  @Test(timeout=1000) public void cell_number3(){
  ...
  @Test(timeout=1000) public void cell_number_trim1(){
    Cell cell = Cell.make("1  "); 
    assertEquals("number"    ,cell.kind());
    assertEquals("1.0"       ,cell.displayString());
    assertEquals("1"         ,cell.contents());
  ...
  @Test(timeout=1000) public void cell_number_trim2(){
    Cell cell = Cell.make("   10.472     "); 
    assertEquals("number"    ,cell.kind());
    assertEquals("10.5"      ,cell.displayString());
    assertEquals("10.472"    ,cell.contents());
  ...
  @Test(timeout=1000) public void getUpstreamIDs_refs1(){
    Cell cell = Cell.make("=A1");
    Set<String> expect = toSet("A1");
    Set<String> actual = cell.getUpstreamIDs();
    assertEquals(expect,actual);
  }
  @Test(timeout=1000) public void getUpstreamIDs_refs2(){
    Cell cell = Cell.make("=2 * 20 + CX5");
    Set<String> expect = toSet("CX5");
    Set<String> actual = cell.getUpstreamIDs();
    assertEquals(expect,actual);
  }
  @Test(timeout=1000) public void getUpstreamIDs_refs3(){
    Cell cell = Cell.make("=-BB8");
    Set<String> expect = toSet("BB8");
    Set<String> actual = cell.getUpstreamIDs();
    assertEquals(expect,actual);
  }
  @Test(timeout=1000) public void getUpstreamIDs_refs4(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
    Set<String> expect = toSet("BB8","A2","CX5");
    Set<String> actual = cell.getUpstreamIDs();
    assertEquals(expect,actual);
  }
  @Test(timeout=1000) public void getUpstreamIDs_refs5(){
    Cell cell = Cell.make("=A1*A1");
    Set<String> expect = toSet("A1");
    Set<String> actual = cell.getUpstreamIDs();
    assertEquals(expect,actual);
  }
  @Test(timeout=1000) public void getUpstreamIDs_refs6(){
  ...
  @Test(timeout=1000) public void cell_formula_error_after_creation1(){
  ...
  @Test(timeout=1000) public void cell_formula_error_after_creation2(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
    assertEquals("formula"   ,cell.kind());
    assertEquals("ERROR"     ,cell.displayString());
  ...
  // 
  // @Test(timeout=1000) public void cell_formula_error_after_creation3(){
  ...
  //   assertEquals(true        ,cell.isError());
  // }
  // @Test(timeout=1000) public void cell_formula_error_after_creation4(){
  ...
  @Test(timeout=1000) public void cell_number_formula1(){
    Cell cell = Cell.make("=5.89"); 
  ...
  @Test(timeout=1000) public void cell_number_formula2(){
    Cell cell = Cell.make("=  8   "); 
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
  ...
  @Test(timeout=1000) public void cell_number_formula_trim1(){
    Cell cell = Cell.make("  =  8   "); 
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
    assertEquals("8.0"       ,cell.displayString());
  ...
  @Test(timeout=1000) public void cell_ref_error1(){
    Cell cell = Cell.make("=A5");
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
    assertEquals("ERROR"     ,cell.displayString());
  ...
  @Test(timeout=1000) public void cell_ref_error2(){
    Cell cell = Cell.make("=2 * 20 + CX5");
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
    assertEquals("ERROR"     ,cell.displayString());
  ...
  @Test(timeout=1000) public void cell_ref_error3(){
    Cell cell = Cell.make("=2 * (20 + CX5)");
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
    assertEquals("ERROR"     ,cell.displayString());
  ...
  @Test(timeout=1000) public void cell_ref_error4(){
    Cell cell = Cell.make("=-BB8");
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
    assertEquals("ERROR"     ,cell.displayString());
  ...
  @Test(timeout=1000) public void cell_ref_error5(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
    cell.updateValue(cellMap()); 
    assertEquals("formula"   ,cell.kind());
    assertEquals("ERROR"     ,cell.displayString());
  ...
  @Test(timeout=1000) public void cell_ref_error6(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
  ...
  @Test(timeout=1000) public void cell_ref_error7(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
  ...
  @Test(timeout=1000) public void cell_ref_error8(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
  ...
  @Test(timeout=1000) public void cell_ref_error9(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
  ...
  // value
  @Test(timeout=1000) public void cell_ref_formula1(){
    Cell cell = Cell.make("=A5");
  ...
  @Test(timeout=1000) public void cell_ref_formula2(){
    Cell cell = Cell.make("=2 * 20 + CX5");
  ...
  @Test(timeout=1000) public void cell_ref_formula3(){
    Cell cell = Cell.make("=2 * (20 + CX5)");
    cell.updateValue(cellMap("A1","2.0","CX5","5.22"));
    assertEquals("formula"    ,cell.kind());
  ...
  @Test(timeout=1000) public void cell_ref_formula4(){
    Cell cell = Cell.make("=-BB8");
  ...
  @Test(timeout=1000) public void cell_ref_formula5(){
    Cell cell = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
    cell.updateValue(cellMap("BB8","-0.5","A1","64.64","A2","200.0","CX5","10"));
    assertEquals("formula"    ,cell.kind());
  ...
  @Test(timeout=1000) public void cell_ref_formula6(){
    Cell cell = Cell.make("=(100 + A2 - (B7*(1+6)) - 10) / (CX5 * BB8 / Z8) + 22 - 0.5*GG67*GG67/BB8+Z2");
  ...
  @Test(timeout=1000) public void multiple_cells1(){
    Cell c1 = Cell.make("1"); 
  ...
  @Test(timeout=1000) public void multiple_cells2(){
    Cell c1 = Cell.make("1"); 
  ...
  @Test(timeout=1000) public void multiple_cells3(){
  ...
  @Test(timeout=1000) public void multiple_cells4(){
    Cell c1 = Cell.make("=A1");
    Cell c2 = Cell.make("=2 * 20 + CX5");
    Cell c3 = Cell.make("=(100 + A2) - 10 / (CX5 * BB8)");
    // Check upstream IDs
  ...
  @Test(timeout=1000) public void cell_formula_stress1(){
    Cell cell = Cell.make("=(100 + A2 - (B7*(1+6)) - 10) / (CX5 * BB8 / Z8) + 22 - 0.5*GG67*GG67/BB8+Z2");
    assertEquals("formula"    ,cell.kind());
    assertEquals("=(100 + A2 - (B7*(1+6)) - 10) / (CX5 * BB8 / Z8) + 22 - 0.5*GG67*GG67/BB8+Z2",cell.contents());
